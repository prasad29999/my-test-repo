        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-1 border-b">
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors flex items-center space-x-2 ${activeTab === "employee"
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors flex items-center space-x-2 ${activeTab === "family"
                  ? "border-blue-600 text-blue-600"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors flex items-center space-x-2 ${activeTab === "academic"
                  ? "border-blue-600 text-blue-600"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors flex items-center space-x-2 ${activeTab === "employment"
                  ? "border-blue-600 text-blue-600"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors flex items-center space-x-2 ${activeTab === "health"
                  ? "border-blue-600 text-blue-600"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors flex items-center space-x-2 ${activeTab === "verification"
                  ? "border-blue-600 text-blue-600"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
                ...
                {familyMembers.map((member, idx) => (
                  <div key={idx} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 border-b pb-4">
                    <div>
                      ...
                      <Select value={member.member_type} onValueChange={value => updateFamilyMember(idx, "member_type", value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Input value={member.member_name} onChange={e => updateFamilyMember(idx, "member_name", e.target.value)} placeholder="Enter name" />
                    </div>
                    <div>
                      <Label>Relation</Label>
                      <Input value={member.relation} onChange={e => updateFamilyMember(idx, "relation", e.target.value)} placeholder="e.g. Father, Spouse" />
                    </div>
                    <div>
                      <Label>Contact Number</Label>
                      <Input value={member.contact} onChange={e => updateFamilyMember(idx, "contact", e.target.value)} placeholder="Enter contact number" />
                    </div>
                    <div>
                      <Label>Location</Label>
                      <Input value={member.location} onChange={e => updateFamilyMember(idx, "location", e.target.value)} placeholder="Enter location" />
                    </div>
                    <div className="flex items-end">
                      <Button variant="destructive" onClick={() => removeFamilyMember(idx)}>
